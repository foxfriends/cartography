--! Previous: sha1:d53067e5e81447b0a8a73fa6f4f7961b16ed6175
--! Hash: sha1:04fbd9b251f7a3d274ef7f6014e0cafebbf74cec
...
EXECUTE PROCEDURE notify_changes ('new_field', 'fields:$1', 'account_id', 'id');

CREATE
OR REPLACE TRIGGER _500_subscription_fields_changed
AFTER
UPDATE ON fields FOR EACH ROW
EXECUTE PROCEDURE notify_changes ('edit_field', 'fields:$1', 'account_id', 'id');
