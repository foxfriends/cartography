...
import type { CardMessage, FieldTileMessage, FieldMessage } from "./Message";
...
export type Channel = "deck" | "fields" | { topic: "field_tiles"; field_id: FieldId };
